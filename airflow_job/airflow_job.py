...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="data_engineering_airflow-project")
    bq_project = Variable.get("bq_project", default_var="inbound-trainer-445609-u9")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "66772270790-compute@developer.gserviceaccount.com",
                "network_uri": "projects/inbound-trainer-445609-u9/global/networks/default",
                "subnetwork_uri": "projects/inbound-trainer-445609-u9/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="inbound-trainer-445609-u9",
        region="us-central1",
